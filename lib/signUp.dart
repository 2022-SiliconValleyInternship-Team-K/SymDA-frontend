    ...
    boxShadow: [
      BoxShadow(
        ...
        offset: Offset(0, 3), // changes position of shadow
          ...
          children: [
             Text('Sign Up',style:TextStyle(fontSize: 20,fontFamily: 'YS',fontWeight: FontWeight.bold,color: const Color(0xff6C584C))),
                ...
                child: Theme(
                  ...
                  child: Container(
                        ...
                        child: Column(children: [
                          signupField("Email", false,Icon(Icons.mail_outline, color: const Color(0xff6C584C),)),
                             Padding(padding: EdgeInsets.only(top: 8)),
                          signupField("Password", true,Icon(Icons.password, color: const Color(0xff6C584C),)),
                             Padding(padding: EdgeInsets.only(top: 8)),
                          signupField("Confirm Password", true,Icon(Icons.password, color: const Color(0xff6C584C),)),
